...
void cargarPDB(){
	...
	FILE *f1 = fopen("TowerOfHanoi_4-18_abst1.pdb", "r");
	FILE *f2 = fopen("TowerOfHanoi_4-18_abst2.pdb", "r");
 
	abs1 = read_abstraction_from_file("TowerOfHanoi_4-18_abst1.abst");
	map1 = read_state_map(f1);

	abs2 = read_abstraction_from_file("TowerOfHanoi_4-18_abst2.abst");
